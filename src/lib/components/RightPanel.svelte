...
{#if mode}
	<aside class="flex h-full w-full flex-col overflow-x-hidden border-l border-border bg-panel">
		<div class="flex shrink-0 items-center justify-between border-b border-border px-3.5 py-2.5">
			...
			<button
				class="inline-flex size-7 items-center justify-center rounded-legacy-xs border-none bg-transparent [background-image:none!important] text-text-muted hover:bg-panel-2 hover:text-ink"
				title="Close"
